<%-- 
    Document   : Request
    Created on : Mar 17, 2025, 3:59:31 PM
                    ...
                    <table cellspacing="18" width="100%">
                        <tr>
                            <td colspan="6" style="text-align:center;color: deeppink;font-weight: bold;font-size: x-large;">
                                View and Sending Request to File Owner
                            </td>
                        </tr>
                        <tr>
                            <th>Name</th>
                        ...
                        <%
                            ps = con.prepareStatement("select * from owner where userid not in(select ownerid from OwnerRequest where userid=?)");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="SendRequest.jsp?userid=<%=session.getAttribute("userid").toString()%>&ownerid=<%=rs.getString(8)%>" style="color:blue;text-decoration: underline;">
                                    Send Request
                                </a>
                            </td>
                        </tr>
