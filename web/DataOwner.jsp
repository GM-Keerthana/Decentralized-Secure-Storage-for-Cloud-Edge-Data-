<%-- 
    Document   : DataOwner
    Created on : Mar 16, 2025, 12:12:13 PM
        ...
        <div id="wrap">
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    <h1>Crypto System</h1>
                    <form name="form1" method="post" action="DataOwner.jsp">
                    ...
                    <%
                        if (request.getParameter("s1") != null) {
                            ps = con.prepareStatement("select * from Owner where userid=? and password=?");
                            ps.setString(1, request.getParameter("t1"));
                            ps.setString(2, request.getParameter("t2"));
                            rs = ps.executeQuery();
                            if (rs.next()) {
                                session.setAttribute("ownerid", rs.getString(8));
                    ...
                    %>
                    <center><a href="OwnerRegistration.jsp" style="font-size: 18px;color: blue;text-decoration: underline;">If New Data Owner? Click Here to Register</a></center>
