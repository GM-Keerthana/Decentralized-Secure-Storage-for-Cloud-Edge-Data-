<%-- 
    Document   : ViewFileStatus
    Created on : Mar 18, 2025, 3:30:04 PM
    Author     : Admin
--%>
                ...
                <div id="main"> <a name="TemplateInfo"></a>
                    ...
                    <table cellspacing="18" width="100%">
                        ...
                        <tr>
                            ...
                            <th>Private Key(User)</th>
                            <th>Go download</th>
                        </tr>
                        <%
                            ps = con.prepareStatement("select * from FileRequest where requesteduser=? and status='Accepted'");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="Download.jsp?fileid=<%=rs.getString(2)%>" style="color: blue;text-decoration: underline;">Download...</a>
                            </td>
                        </tr>
                        <%
                            }
