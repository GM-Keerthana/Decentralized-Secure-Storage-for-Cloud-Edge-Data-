...
public final class UserRegistration_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    PreparedStatement ps;
                        ...
                        public String generatePrivateKey() {
                            ...
                            if(n<10)
                                s1 = "000"+Integer.toHexString(n);
                            else if(n<100)
                                s1 = "00"+Integer.toHexString(n);
                            else if(n<1000)
                                s1 = "0"+Integer.toHexString(n);
                            else
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/CryptoSystem","root","");
      ...
      out.write("                                <td><input type=\"text\" name=\"dob\" value=\"\" required onblur=\"fun1();\"/></td>\n");
      out.write("                            </tr>\n");
      out.write("                            <tr>\n");
      out.write("                                <td>Age</td>\n");
      ...
      out.write("                    ");
                        ...
                        if (request.getParameter("s1") != null) {
                            ...
                            ps.executeUpdate();
                            ps.close();
                            out.println("<center><span style='color:blue;font-size:medium;font-weight: bold;'>User Info Registered..</span></center>");
                        }
