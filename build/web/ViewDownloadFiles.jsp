<%-- 
    Document   : ViewDownloadFiles
    Created on : Mar 19, 2025, 4:53:43 PM
            ...
            <div id="content-wrap">
                <div id="main"> <a name="TemplateInfo"></a>
                    ...
                    <table cellspacing="18" width="100%" >
                        <tr>
                                <td colspan="8" style="text-align:center;color: deeppink;font-weight: bold;font-size: large;">
                                    View Downloaded & Accepted Files by Data Owner
                                </td>
                            </tr>
                        <tr>
                            <th>File Id</th>
                    ...
                    <%
                        ps=con.prepareStatement("select * from FileRequest where ownerid=? and status='Accepted'");
