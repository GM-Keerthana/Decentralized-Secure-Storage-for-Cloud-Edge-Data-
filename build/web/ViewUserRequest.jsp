<%-- 
    ...
    Created on : Mar 17, 2025, 5:02:08 PM
                    ...
                    <table cellspacing="18" width="100%">
                        <tr>
                            <td colspan="6" style="text-align:center;color: deeppink;font-weight: bold;font-size: x-large;">
                                View Requested User Information
                            </td>
                        </tr>
                        <tr>
                            <th>Name</th>
                        ...
                        <%
                            ps = con.prepareStatement("select * from User where userid in(select userid from OwnerRequest where ownerid=? and status='Requested')");
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="SendResponse.jsp?ownerid=<%=session.getAttribute("ownerid").toString()%>&userid=<%=rs.getString(8)%>&status=Accept" style="color:blue;text-decoration: underline;">
                                    Accept
                                </a>
                                    &nbsp;/&nbsp;
                                <a href="SendResponse.jsp?ownerid=<%=session.getAttribute("ownerid").toString()%>&userid=<%=rs.getString(8)%>&status=Reject" style="color:blue;text-decoration: underline;">
                                    Reject
                                </a>
                            </td>
                        </tr>
